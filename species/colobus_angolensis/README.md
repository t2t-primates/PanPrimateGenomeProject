...
| Accession ID | [PR00099](../../manifests/sample_data_manifest.csv) |
| NCBI BioSample | |
| S3 Data Location | s3://panprimate-t2t/species_data/PR00099/ *(not yet public)* |
| Project phase | 1 |
...
| | |
| --- | --- |
| IUCN status | [Vulnerable](https://www.iucnredlist.org/species/5142/274973854) |
...
| PacBio HiFi | 57x |
| ONT | 53x |
| Hi-C (chromatin capture) | 660M reads |
| Kinnex RNA | 14M reads |

## Genome quality

| Metric | Hap1 | Hap2 |
| --- | --- | --- |
| Genome size (Gbp) | 3.33 | 3.14 |
| contig N50 (Mbp) | 152.82 | 163.85 |
| BUSCO | complete single: 98.09%<br>complete duplicate: 1.75%<br>total frag: 0.04%<br>missing: 0.12% | complete single: 95.44%<br>complete duplicate: 1.77%<br>total frag: 0.04%<br>missing: 2.75% |
| QV | 60.2 | 59.4 |
